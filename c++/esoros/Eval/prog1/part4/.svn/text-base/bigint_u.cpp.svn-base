...
#include "bigint.h"
  ...
  */ 
  ...
  {  
	...
	std::cout << c.shift_left(3) << " Shift Left 3";
	
	std::cout << std::endl << bigint(0) * 8;
	std::cout << std::endl << bigint(1) * 8;
	std::cout << std::endl << bigint(156) * 8;
	std::cout << std::endl << bigint("12368123") * 8;
	std::cout << std::endl << bigint("12123123") * 1;
	std::cout << std::endl << bigint("12312333") * 0;
	
	
	std::cout << std::endl << 9 * bigint(8);
	std::cout << std::endl << 6 * bigint(1234);
	std::cout << std::endl << 0 * bigint(1234);
	
	std::cout << std::endl << "Forwards";
	std::cout << std::endl << bigint(123) * bigint(0);
	std::cout << std::endl << bigint("12345") * bigint(56);
	std::cout << std::endl << bigint(123) * bigint(56);
	std::cout << std::endl << bigint(10) * bigint(10);
	std::cout << std::endl << bigint(0) * bigint(1);
	
	std::cout << std::endl << "Backwards";
	std::cout << std::endl << bigint("0")* bigint(123);
	std::cout << std::endl << bigint("56") * bigint("12345");
	std::cout << std::endl << bigint("56") * bigint("123");
	
	
	std::cout << std::endl << factorial(100);
